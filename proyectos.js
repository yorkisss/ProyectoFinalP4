...
lib.ssMetadata = [
		{name:"proyectos_atlas_1", frames: [[898,0,896,1280],[0,0,896,1344]]},
		{name:"proyectos_atlas_2", frames: [[0,0,736,1349],[0,1351,405,371]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.686,0.5445);
...
p.nominalBounds = new cjs.Rectangle(0,0,614.7,731.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.7816,0.5906);
...
p.nominalBounds = new cjs.Rectangle(0,0,575.3,796.7);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.6112,0.5176);
...
p.nominalBounds = new cjs.Rectangle(0,0,547.7,662.5);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.text = new cjs.Text("Blueberry yogurt", "bold 80px 'Tw Cen MT Condensed'");
	this.text.textAlign = "center";
	this.text.lineHeight = 87;
	this.text.lineWidth = 358;
	this.text.parent = this;
	this.text.setTransform(180.8,2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1).to({color:"#660033"},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,361.7,223);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.text = new cjs.Text("Caramel coffee", "bold 80px 'Tw Cen MT Condensed'");
	this.text.textAlign = "center";
	this.text.lineHeight = 87;
	this.text.lineWidth = 385;
	this.text.parent = this;
	this.text.setTransform(194.55,2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1).to({color:"#993300"},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,389.2,186.3);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.text = new cjs.Text("Choco menta", "bold 80px 'Tw Cen MT Condensed'");
	this.text.textAlign = "center";
	this.text.lineHeight = 87;
	this.text.lineWidth = 376;
	this.text.parent = this;
	this.text.setTransform(477.25,2);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1).to({color:"#003300"},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(287.3,0,379.99999999999994,243.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(273.8,331.2,1,1,0,0,0,273.8,331.2);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(307.3,365.9,1,1,0,0,0,307.3,365.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(287.6,398.4,1,1,0,0,0,287.6,398.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1440.55,529.25,1,1,0,0,0,180.8,111.5);
	new cjs.ButtonHelper(this.instance, 0, 1, 1);

	this.instance_1 = new lib.Símbolo7();
	this.instance_1.setTransform(853.35,510.95,1,1,0,0,0,194.6,93.2);
	new cjs.ButtonHelper(this.instance_1, 0, 1, 1);

	this.instance_2 = new lib.Símbolo4();
	this.instance_2.setTransform(-6.25,539.45,1,1,0,0,0,190,121.7);
	new cjs.ButtonHelper(this.instance_2, 0, 1, 1);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#666666").s().p("EBJqAB6IAAh6MAiZAAAIAAB6gA1pB6IAAh6MAiYAAAIAAB6gEhsCAAAIAAh5MAiZAAAIAAB5g");
	this.shape.setTransform(868.375,667.35);
	...
	this.text.parent = this;
	this.text.setTransform(879.3,12.65);

	this.instance_3 = new lib.NewProject20();
	this.instance_3.setTransform(32,59,0.3839,0.2898);

	this.instance_4 = new lib.Símbolo3();
	this.instance_4.setTransform(1430.3,510.9,1,1,0,0,0,307.3,365.9);
	new cjs.ButtonHelper(this.instance_4, 0, 1, 1);

	this.instance_5 = new lib.Símbolo2();
	this.instance_5.setTransform(835.25,545.9,1,1,0,0,0,287.6,398.4);
	new cjs.ButtonHelper(this.instance_5, 0, 1, 1);

	this.instance_6 = new lib.Símbolo1();
	this.instance_6.setTransform(273.8,476.2,1,1,0,0,0,273.8,331.2);
...
p.nominalBounds = new cjs.Rectangle(816.9,407.2,920.8000000000001,537);
// library properties:
lib.properties = {
	id: '04F93828FAAA5B46B9DF95207EBFBF16',
	width: 1696,
	height: 793,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/proyectos_atlas_1.png?1778207650599", id:"proyectos_atlas_1"},
		{src:"images/proyectos_atlas_2.png?1778207650599", id:"proyectos_atlas_2"}
	],
	preloads: []
};
...
an.compositions['04F93828FAAA5B46B9DF95207EBFBF16'] = {
